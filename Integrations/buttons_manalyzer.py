$submitfileButton.Add_Click({
    ...
    $pythonScript = "submit_file_manalyzer.py"
    $pythonExe = "python"
...
$buttonRetrieveReportfile.Add_Click({
    ...
    $Response = Invoke-RestMethod -Uri "https://manalyzer.org/api/report/$script:TaskId" -Method Get 
...
$buttonBoxEmAll.Add_Click({
    ...
    $pythonScript = "mass_submit_files_manalyzer.py"
    $pythonExe = "python"
